...
async def async_setup_entry(
    ...
    if type(device) is F1500:
        ...
        add_sensor("Expansion Battery Percentage", "%", "battery_percentage_expansion", SensorDeviceClass.BATTERY)
        add_sensor("Charging Status", None, "charging_status")
        add_sensor("Battery Health", "%", "battery_health")
        add_sensor("Expansion Battery Health", "%", "battery_health_expansion")
        add_sensor("Maximum Battery Percentage", "%", "max_battery_percentage", SensorDeviceClass.BATTERY)
        add_sensor("Minimum Battery Percentage", "%", "min_battery_percentage", SensorDeviceClass.BATTERY)
        add_sensor("Number Of Expansion Batteries", None, "num_expansion")
        add_sensor("Temperature", UnitOfTemperature.CELSIUS, "temperature", SensorDeviceClass.TEMPERATURE)
        add_sensor("Expansion Battery Temperature", UnitOfTemperature.CELSIUS, "temperature_expansion", SensorDeviceClass.TEMPERATURE)
        ...
        add_sensor("Expansion Battery Firmware Version", None, "software_version_expansion")
